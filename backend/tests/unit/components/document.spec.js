...
describe('deleteDocument', () => {
  ...
  it('should return CONFLICT if secureExchange is CLOSED', async () => {
    ...
    utils.getData.mockResolvedValue(sampleDataJsonResponse);
    req = mockRequest(null, session, params);
