...
router.post('/users/roles/school', passport.authenticate('jwt', {session: false}, undefined), isValidBackendToken, validateAccessToken, findSchoolID_body_params, checkEdxUserPermission(PERMISSION.EDX_USER_SCHOOL_ADMIN), checkEDXUserAccessToRequestedInstitute, updateEdxUserSchoolRoles);
router.post('/users/roles/district', passport.authenticate('jwt', {session: false}, undefined), isValidBackendToken, validateAccessToken, findDistrictID_body_params, checkEdxUserPermission(PERMISSION.EDX_USER_DISTRICT_ADMIN), checkEDXUserAccessToRequestedInstitute, updateEdxUserDistrictRoles);
...
router.get('/all-district-school-users', passport.authenticate('jwt', {session: false}, undefined), isValidBackendToken, validateAccessToken, findDistrictID_query, checkEdxUserPermission(PERMISSION.EDX_USER_DISTRICT_ADMIN), checkEDXUserAccessToRequestedInstitute, getAllDistrictSchoolEdxUsers);
router.post('/school-user-activation-invite', passport.authenticate('jwt', {session: false}, undefined), isValidBackendToken, validateAccessToken, findSchoolID_body, checkEdxUserPermission(PERMISSION.EDX_USER_SCHOOL_ADMIN), checkEDXUserAccessToRequestedInstitute, schoolUserActivationInvite);
router.post('/district-user-activation-invite', passport.authenticate('jwt', {session: false}, undefined), isValidBackendToken, validateAccessToken, findDistrictID_body, checkEdxUserPermission(PERMISSION.EDX_USER_DISTRICT_ADMIN), checkEDXUserAccessToRequestedInstitute, districtUserActivationInvite);
