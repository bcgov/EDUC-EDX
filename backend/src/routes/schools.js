...
const { getSchoolBySchoolID, getSchoolLastUpdated, getAllCachedSchools, getAllSchoolDetails } = require('../components/school');
...
router.get('/lastUpdated', passport.authenticate('jwt', {session: false}, undefined), isValidBackendToken, getSchoolLastUpdated);
