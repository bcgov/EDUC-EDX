...
const { getStudentByPEN, getStudentByPENForGrad, createNewStudent, getStudentByPENForAssessment} = require('../components/student');
...
router.get('/search-assessment-pen', passport.authenticate('jwt', {session: false}, undefined), isValidBackendToken, validateAccessToken, checkEdxUserPermission(PERMISSION.GRAD_SCH_RPT_VIEW), getStudentByPENForAssessment);
