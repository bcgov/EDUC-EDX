...
function getNumberOfCourses(numCourses){
  if(!numCourses){
    return '-';
  }
  let isValidNumber = isNumeric(numCourses);

  if(!isValidNumber){
    return numCourses;
  }

  return parseFloat(numCourses) / 100;
}
...
function getFileDetails(reportType, mincode) {
  const mappings = {
    ...
    'ALL_STUDENT_FRENCH_DIS_CSV': { filename: `AllDistrictFrenchStudents_${mincode}.csv`, contentType: 'text/csv' },
    ...
    'DIS_REFUGEE_HEADCOUNT_PER_SCHOOL': { filename: `EligibleNewcomerRefugeesBySchool_District_${mincode}.pdf`, contentType: 'application/pdf' },
    'SPECIAL_EDUCATION_HEADCOUNT': { filename: `EligibleInclusiveEdHeadcount_School_${mincode}.pdf`, contentType: 'application/pdf' },
    'DIS_SPECIAL_EDUCATION_HEADCOUNT': { filename: `EligibleInclusiveEdHeadcount_District_${mincode}.pdf`, contentType: 'application/pdf' },
    'DIS_SPECIAL_EDUCATION_HEADCOUNT_PER_SCHOOL': { filename: `EligibleInclusiveEdHeadcountPerSchool_District_${mincode}.pdf`, contentType: 'application/pdf' },
    'DIS_SPECIAL_EDUCATION_HEADCOUNT_CATEGORY_PER_SCHOOL': { filename: `EligibleInclusiveEdCategoryHeadcountPerSchool_District_${mincode}.pdf`, contentType: 'application/pdf' },
    'INDIGENOUS_HEADCOUNT': { filename: `EligibleIndigenousSupportProgramHeadcount_School_${mincode}.pdf`, contentType: 'application/pdf' },
    'DIS_INDIGENOUS_HEADCOUNT': { filename: `EligibleIndigenousSupportProgramHeadcount_District_${mincode}.pdf`, contentType: 'application/pdf' },
    'DIS_INDIGENOUS_HEADCOUNT_PER_SCHOOL': { filename: `EligibleIndigenousSupportProgramHeadcountPerSchool_District_${mincode}.pdf`, contentType: 'application/pdf' },
    'BAND_RESIDENCE_HEADCOUNT': { filename: `EligibleBandOfResidenceHeadcount_School_${mincode}.pdf`, contentType: 'application/pdf' },
    'DIS_BAND_RESIDENCE_HEADCOUNT': { filename: `EligibleBandOfResidenceHeadcount_District_${mincode}.pdf`, contentType: 'application/pdf' },
    'DIS_BAND_RESIDENCE_HEADCOUNT_PER_SCHOOL': { filename: `EligibleBandOfResidenceHeadcountPerSchool_District_${mincode}.pdf`, contentType: 'application/pdf' },
    'CAREER_HEADCOUNT': { filename: `EligibleCareerProgramHeadcount_School_${mincode}.pdf`, contentType: 'application/pdf' },
    'FRENCH_HEADCOUNT': { filename: `EligibleFrenchProgramHeadcount_School_${mincode}.pdf`, contentType: 'application/pdf' },
    'DIS_FRENCH_HEADCOUNT': { filename: `EligibleFrenchProgramHeadcount_District_${mincode}.pdf`, contentType: 'application/pdf' },
    'DIS_FRENCH_HEADCOUNT_PER_SCHOOL': { filename: `EligibleFrenchProgramHeadcountPerSchool_District_${mincode}.pdf`, contentType: 'application/pdf' },
    'GRADE_ENROLLMENT_HEADCOUNT': { filename: `GradeEnrolment-EligibleFTE_School_${mincode}.pdf`, contentType: 'application/pdf' },
    'DIS_GRADE_ENROLLMENT_HEADCOUNT': { filename: `EligibleEnrolment-FTE_District_${mincode}.pdf`, contentType: 'application/pdf' },
    'DIS_GRADE_ENROLLMENT_HEADCOUNT_PER_SCHOOL': { filename: `EligibleEnrolment-FTEperSchool_District_${mincode}.pdf`, contentType: 'application/pdf' },
...
async function getStudentDifferencesByInstituteCollectionId(req, res) {
  try {
    ...
    data.content.forEach(difference => {
