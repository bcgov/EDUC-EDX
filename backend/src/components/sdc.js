...
function getFileDetails(reportType, mincode) {
  const mappings = {
    ...
    'BAND_RESIDENCE_HEADCOUNT': { filename: `EligibleBandOfResidenceHeadcountAndFte_School_${mincode}.pdf`, contentType: 'application/pdf' },
    'DIS_BAND_RESIDENCE_HEADCOUNT': { filename: `EligibleBandOfResidenceHeadcountAndFte_District_${mincode}.pdf`, contentType: 'application/pdf' },
    'DIS_BAND_RESIDENCE_HEADCOUNT_PER_SCHOOL': { filename: `EligibleBandOfResidenceHeadcountAndFtePerSchool_District_${mincode}.pdf`, contentType: 'application/pdf' },
