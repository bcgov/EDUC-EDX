...
export class InstituteSetupUtils {
    ...
    async setupInstituteEntities({ districtOptions = {}, schoolOptions = {} }: InstituteOptions) {
        ...
        schoolOptions?.withPrimaryActivationCode ?
            await this.edxApi.verifySchoolActivationCodes(school.schoolId) :
            await this.edxApi.deletePrimaryActivationCode('SCHOOL', school.schoolId);
