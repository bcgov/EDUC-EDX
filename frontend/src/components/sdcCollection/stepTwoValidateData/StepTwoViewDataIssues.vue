    ...
    >
      <div class="border">
        ...
        <v-row v-else class="justify-center">
            <v-col cols="5">
                <v-row class="inner-border box-height" style="padding: 0;">
                    <v-row>
                        <v-col>
                            <h3 class="heading">Data Issues</h3>
                        </v-col>
                    </v-row>
                    <v-row>
                        <v-col
            ...
            <v-col cols="3">
                <v-row class="inner-border box-height" style="padding: 0;">
                    <v-row>
                        <v-col>
                            <h3 class="heading">Student Records with Data Issues</h3>
                        </v-col>
                    </v-row>
                    <v-row>
                        <v-col  id="totalStudentsWithIssues"
                        class="d-flex flex-wrap justify-space-evenly"
                        style="text-align: center;">
          ...
          >
            ...
            <v-row>
              <v-data-table-server
                ...
                show-select
              >
              <template v-slot:column.error="{ column }">
                <v-icon
                      class="mt-2 mr-3"
                      size="25"
                      color="#d90606"
               ...
               <template v-slot:column.fundingWarning="{ column }">
                <v-icon
                      class="mt-2 mr-3"
                      size="25"
                      color="#ff9800"
               ...
               <template v-slot:column.infoWarning="{ column }">
                <v-icon
                      class="mt-2 mr-3"
                      size="25"
                      color="#2196F3"
