  ...
  data() {
    return {
      ...
      courseHeaders: [
        ...
        { title: 'Interim Letter Grade', key: 'interimLetterGrade', align: 'start', sortable: true },
        { title: 'Final Percentage', key: 'finalPercentage', align: 'start', sortable: true },
        { title: 'Final Letter Grade', key: 'finalLetterGrade', align: 'start', sortable: true },
