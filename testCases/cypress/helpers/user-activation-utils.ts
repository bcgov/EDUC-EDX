...
const userActivationUtils = {
  createEdxActivationCode(isPrimary: null, roles: string | any[], activationCode: null, instituteTypeCode: { toString: () => string; }, instituteID: null) {
   ...
   */
  async deleteUserActivationCodes(userID: any) {
