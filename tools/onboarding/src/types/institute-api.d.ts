declare interface NoteEntity extends BaseApiEntity {
  noteId: string;
  schoolId: string;
  districtId: string;
  content: string;
...
declare interface ContactEntity extends BaseApiEntity {
...
declare interface AuthorityContactEntity extends ContactEntity {
  authorityContactId: string;
  independentAuthorityId: string;
  authorityContactTypeCode: string;
}

declare interface SchoolContactEntity extends ContactEntity {
  schoolContactId: string;
  schoolId: string;
  schoolContactTypeCode: string;
}

declare interface DistrictContactEntity extends ContactEntity {
  districtContactId: string;
  districtId: string;
  districtContactTypeCode: string;
}

declare interface BaseAddressEntity extends BaseApiEntity {
  addressLine1: string;
...
declare interface DistrictAddressEntity extends BaseAddressEntity {
  districtAddressId: string;
  districtId: string;
}

declare interface SchoolAddressEntity extends BaseAddressEntity {
...
declare interface DistrictEntity extends BaseApiEntity {
  districtId: string;
...
declare interface NeighborhoodLearningEntity extends BaseApiEntity {
  neighborhoodLearningId: string;
  schoolId: string;
  NeighborhoodLearningTypeCode: NeighborhoodLearningTypeCodeKey;
}

declare interface SchoolMoveEntity extends BaseApiEntity {
...
declare interface SchoolEntity extends BaseApiEntity {
  schoolId: string;
  districtId: string;
  mincode: string;
  independentAuthorityId: string;
...
declare interface BasePaginatedResponse {
  totalPages: number;
...
declare interface PaginatedSchoolResponse extends BasePaginatedResponse {
